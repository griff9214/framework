 ...
 */
final class Version20200824123013 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , title VARCHAR(255) NOT NULL, content_short CLOB NOT NULL, content_full CLOB NOT NULL, meta_title VARCHAR(255) NOT NULL, meta_keywords CLOB NOT NULL, meta_description CLOB NOT NULL)');
    }
